...
public class Menu implements CommandeNeutre {
	...
	public Commande copie() {
		// XXX : Ce n'est certainement pas le bon traitement à réaliser !
		// Il faudrait copier le menu, en particulier les entrées et l'état.
		return this;
	}
